...
function [psi1,psi2] = anglesubtended_limits(x1,y1,a1,b1,theta1,x2,y2,a2,b2,theta2,varargin)
  
[debug,hax] = myparse(varargin,'debug',false,'hax',nan);
...
for n1 = 1:N1,
  for n2 = 1:N2,
    ...
    % direction to fly 2 from fly 1
    psi = atan2(y2(n2)-(y1(n1)+a1(n1)*sin(theta1(n1))),x2(n2)-(x1(n1)+a1(n1)*cos(theta1(n1))))-theta1(n1);
    
    % corner case -- tiny fly
    ...
    if debug,
      ...
      hold on;
      text(x1(n1),y1(n1),'1','Color',colors(1));
      ellipsedraw(a2(n2),b2(n2),x2(n2),y2(n2),theta2(n2),colors(2));
      text(x2(n2),y2(n2),'2','Color',colors(2));
      plot(c1,d1,[colors(1),'o']);
      e1 = c1+cos(psi+theta1(n1))*s;
      f1 = d1+sin(psi+theta1(n1))*s;
      hpsi = plot([c1,e1],[d1,f1],'m:');
      ...
      input(sprintf('psi1 = %f, psi2 = %f ',psi1(n1,n2),psi2(n1,n2)))
    end;
